    ...
    def on_created(self, event):
        ...
        if event.src_path.lower().endswith('.csv'):
            ...
            if not event.is_directory:
                ...
                file_sql_query = "INSERT INTO mysql.app_files(file_path,sys_creation_date,sys_update_date,DL_UPDATE,Application_ID,status,pid) VALUES (%s,%s,%s,%s,%s,%s,%s)"
                data=(fp, date.today(), date.today(),'APPPY','121','PN',os.getpid())
...
if __name__ == "__main__":
    ...
    path = r"C:\Users\Ameer\Downloads"                              #folder to watch to listen
